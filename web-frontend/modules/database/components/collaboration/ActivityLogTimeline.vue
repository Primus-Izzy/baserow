<template>
  <div class="activity-log-timeline">
    <div class="activity-log-timeline__header">
      <h3 class="activity-log-timeline__title">
      ...
      <div class="activity-log-timeline__controls">
        <Button
          ...
          size="small"
          :class="{
            'activity-log-timeline__view-toggle--active':
              viewMode === 'timeline',
          }"
        ...
        <Button
          ...
          size="small"
          :class="{
            'activity-log-timeline__view-toggle--active': viewMode === 'list',
          }"
    ...
    <div class="activity-log-timeline__filters">
      ...
      <Dropdown
        ...
        @input="applyFilters"
      >
        <DropdownItem :name="$t('activityLog.allUsers')" :value="null" />
        <DropdownItem
      ...
      <Button type="secondary" size="small" @click="clearFilters">
      ...
      <div class="activity-log-timeline__live-indicator">
        ...
        <span class="activity-log-timeline__live-text">
          {{
            isRealTimeEnabled
              ? $t('activityLog.timeline.live')
              : $t('activityLog.timeline.paused')
          }}
        </span>
        <Button type="ghost" size="tiny" @click="toggleRealTime">
    ...
    <div class="activity-log-timeline__content">
      <div v-if="loading" class="activity-log-timeline__loading">
      ...
      <div v-else class="activity-log-timeline__entries">
        <div
        ...
        <div v-else class="activity-log-timeline__list">
          <ActivityLogEntry
        ...
        <div v-if="hasMore" class="activity-log-timeline__load-more">
