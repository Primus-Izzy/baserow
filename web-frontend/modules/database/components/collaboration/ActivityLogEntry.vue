    ...
    <div class="activity-log-entry__content">
      ...
      >
        ...
        <div
          ...
          class="activity-log-entry__field"
        >
        ...
        <div
          ...
          class="activity-log-entry__view"
        >
        ...
        >
          ...
          {{ $tc('activityLog.mentions', entry.details.mentions_count, { count: entry.details.mentions_count }) }}
        </div>
      </div>
    </div>
