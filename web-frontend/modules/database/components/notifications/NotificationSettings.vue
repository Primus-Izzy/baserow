            ...
            <div class="notification-types">
              ...
              >
                <div class="type-header">
                  ...
                  <span class="type-category">{{ notificationType.category }}</span>
                </div>
                ...
                <div class="delivery-methods">
                  ...
                  >
                    <label class="checkbox-label">
                      <input
                        type="checkbox"
                        :checked="isMethodEnabled(notificationType.name, method)"
                        @change="updateMethodPreference(notificationType.name, method, $event.target.checked)"
                      />
  ...
  methods: {
    ...
    updateBatchingPreference() {
      ...
      Object.keys(this.preferences).forEach(typeName => {
        this.preferences[typeName].email_batch_frequency = this.emailBatchFrequency
      })
    },
    ...
    updateQuietHoursPreference() {
      ...
      Object.keys(this.preferences).forEach(typeName => {
        ...
        this.preferences[typeName].quiet_hours_timezone = this.quietHoursTimezone
      })
    },
