<template>
  <div class="chart-configuration">
    <div class="chart-configuration__section">
      ...
      <div class="chart-configuration__chart-types">
        <div
          ...
          :class="{ 'chart-configuration__chart-type--active': configuration.chart_type === type.value }"
          @click="updateConfiguration('chart_type', type.value)"
        >
          <i :class="type.icon" class="chart-configuration__chart-type-icon"></i>
          <span class="chart-configuration__chart-type-label">{{ type.label }}</span>
        </div>
      </div>
    </div>
      ...
      <div class="chart-configuration__options">
        ...
        <label class="chart-configuration__option">
          <input
            ...
            type="checkbox"
            @change="updateConfiguration('show_tooltips', $event.target.checked)"
          />
        ...
        <label class="chart-configuration__option">
          <input
            ...
            type="checkbox"
            @change="updateConfiguration('enable_animations', $event.target.checked)"
          />
    ...
    <div v-if="configuration.enable_animations" class="chart-configuration__section">
      ...
      <div class="chart-configuration__field">
        ...
        <input
          ...
          max="5000"
          step="100"
          @input="updateConfiguration('animation_duration', $event.target.value)"
        />
      </div>
    </div>
      ...
      <div class="chart-configuration__options">
        <label class="chart-configuration__option">
          <input
            ...
            type="checkbox"
            @change="updateConfiguration('real_time_enabled', $event.target.checked)"
          />
          <span>Enable Real-time Updates</span>
        </label>
        
        <label v-if="configuration.real_time_enabled" class="chart-configuration__option">
          <input
            v-model="configuration.use_websocket"
            type="checkbox"
            @change="updateConfiguration('use_websocket', $event.target.checked)"
          />
          <span>Use WebSocket (faster updates)</span>
        </label>
      </div>
      
      <div v-if="configuration.real_time_enabled" class="chart-configuration__field">
    ...
    <div class="chart-configuration__section">
      ...
      <div class="chart-configuration__color-schemes">
        <div
          ...
          :class="{ 'chart-configuration__color-scheme--active': configuration.color_scheme === scheme.name }"
        ...
        >
          ...
          <span class="chart-configuration__color-scheme-name">{{ scheme.label }}</span>
        </div>
      </div>
    </div>
        ...
        <div class="chart-configuration__axis">
          ...
          <label class="chart-configuration__option">
            <input
              ...
              type="checkbox"
              @change="updateConfiguration('x_axis_display', $event.target.checked)"
            />
            <span>Show X-Axis</span>
          </label>
          <div v-if="configuration.x_axis_display" class="chart-configuration__field">
        ...
        <div class="chart-configuration__axis">
          ...
          <label class="chart-configuration__option">
            <input
              ...
              type="checkbox"
              @change="updateConfiguration('y_axis_display', $event.target.checked)"
            />
            <span>Show Y-Axis</span>
          </label>
          <div v-if="configuration.y_axis_display" class="chart-configuration__field">
  ...
  data() {
    return {
      availableChartTypes: [
        ...
        { value: 'stacked-bar', label: 'Stacked Bar', icon: 'fas fa-chart-bar' },
        { value: 'horizontal-bar', label: 'Horizontal Bar', icon: 'fas fa-chart-bar' },
