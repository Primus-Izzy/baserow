<template>
  ...
  >
    <div class="dashboard-export-modal">
      ...
      <div class="export-options">
        ...
        <div v-if="exportConfig.format === 'pdf'" class="pdf-options">
          <div class="form-group">
            ...
            <select v-model="exportConfig.configuration.pageSize" class="form-control">
          ...
          <div class="form-group">
            ...
            <select v-model="exportConfig.configuration.orientation" class="form-control">
              <option value="portrait">{{ $t('dashboardExport.portrait') }}</option>
              <option value="landscape">{{ $t('dashboardExport.landscape') }}</option>
            </select>
          </div>
        </div>
        ...
        <div v-if="exportConfig.format === 'png'" class="png-options">
          <div class="form-group">
            ...
            <select v-model="exportConfig.configuration.resolution" class="form-control">
              <option value="1x">{{ $t('dashboardExport.resolution1x') }}</option>
              <option value="2x">{{ $t('dashboardExport.resolution2x') }}</option>
              <option value="3x">{{ $t('dashboardExport.resolution3x') }}</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          <label>
            <input
              v-model="exportConfig.includeTitle"
              type="checkbox"
            />
      ...
      <div class="delivery-options">
        ...
        <div class="form-group">
          <label>
            <input
              v-model="exportConfig.sendEmail"
              type="checkbox"
            />
      ...
      <div class="scheduling-options">
        ...
        <div class="form-group">
          <label>
            <input
              v-model="exportConfig.isScheduled"
              type="checkbox"
            />
        ...
        <div v-if="exportConfig.isScheduled" class="schedule-config">
          <div class="form-group">
            ...
            <select v-model="exportConfig.scheduleType" class="form-control">
              ...
              <option value="monthly">{{ $t('dashboardExport.monthly') }}</option>
            </select>
          </div>
    ...
    <template #footer>
      ...
      >
        <i class="fas fa-download"></i>
        {{ exportConfig.isScheduled ? $t('dashboardExport.scheduleExport') : $t('dashboardExport.startExport') }}
      </button>
    </template>
  </Modal>
</template>
